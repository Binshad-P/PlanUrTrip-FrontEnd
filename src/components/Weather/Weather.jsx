...
const Weather = () => {
  ...
  return (
    <>
      <div className="flex ">
        <div className="flex flex-col justify-center items-center bg-[#8dd3ba] p-3 rounded-tl-lg rounded-bl-lg sm-max:hidden">
        ...
        <div className="bg-[#ffffffae] p-5 rounded-tr-lg rounded-br-lg sm-max:hidden">
          <div>
            ...
            <div className="flex justify-between items-center mt-[15px]">
              <div>
                <p className="font-bold text-2xl">{data?.main?.temp}°C</p>
              </div>
        ...
        <div className="text-white  lg:hidden md-max:hidden sm-max:block">
          <p className="flex items-center text-[#ffffffc3]">
            <MdDateRange />
            {moment().format("LL")}
          </p>
          <p className="font-bold text-sm flex text-[#ffffffc3] ">
            <CiTempHigh color="#ffffffc3" />
            {data?.main?.temp}°C
          </p>
        </div>
      </div>
